            ...
            {currentMusic.map((music) => {
              return (
                <Fragment key={music.id}>
                  <div className="w-[40%] flex justify-center drop-shadow-2xl m-auto rounded-3xl overflow-hidden">
                  ...
                  <div className="flex justify-evenly md:flex-row flex-col  mt-6">
                    <a href={music.music} className="flex justify-between md:w-[45%] w-full md:mb-0 mb-2 bg-five items-center hover:bg-four transition duration-150 ease-out text-[#ccc] p-2 rounded-md" download>
                      <span>
                        دانلود آهنگ{" "}
