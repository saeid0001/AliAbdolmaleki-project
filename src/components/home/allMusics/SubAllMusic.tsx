  ...
  return (
    <>
      ...
      >
        ...
        <div className="group-hover:flex text-center justify-center items-center flex-col absolute group-hover:top-0 group-hover:right-0 group-hover:bottom-0 transition duration-300 ease-out group-hover:bg-four group-hover:bg-opacity-80 group-hover:text-[#ccc]  group-hover:w-full">
          <p>{namefa}</p>
          <p>{nameen}</p>
