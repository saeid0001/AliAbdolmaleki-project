...
import { AllAlbum, LoadingAlbum } from "../../../context/albumSlice/AlbumSlice";
...
const NewAlbum = () => {
  ...
  const AlbumeNew = useSelector(AllAlbum);
  const LoadingA = useSelector(LoadingAlbum);
  ...
  return (
    <section className="p-8 my-12" data-aos="fade-down">
      ...
      {!LoadingA && (
        <div className="pt-12 flex md:flex-row flex-col-reverse justify-between items-center">
          {AlbumeNew.map((album) => {
            return (
              <Fragment key={album.id}>
                ...
                <div className="md:w-[45%] w-[100%] pt-12">
                  <div className="h-[500px] overflow-y-scroll mb-6">
