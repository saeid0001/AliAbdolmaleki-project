...
const WaveSurferPlayer = (props: WaveSurferOptions) => {
  ...
  const wavesurfer = useWavesurfer(containerRef, props) as WaveSurfer;
  ...
  useEffect(() => {
    ...
    const subscriptions = [
      ...
      wavesurfer.on("decode", (cur) => setFullTime(FormatTime(cur))),
  ...
  return (
    <>
      {fullTime === "00:00" && <div className="custom-loader"></div>}
      <div className="relative my-4">
        {fullTime !== "00:00" && (
          <div className=" flex justify-evenly w-full items-center mb-4">
            <button
              type="button"
            ...
            <input
              ...
              value={volumeMusic}
              style={{
                background: `linear-gradient(to right, #a46352 ${volumeMusic}%, #ccc ${volumeMusic}%)`,
                width: "50%",
              }}
            />
            <div
        ...
        {fullTime !== "00:00" && (
          <>
            <span className=" absolute top-[57%] z-[2] left-[-45px] text-one">
              {currentTime}
            </span>
            <span className=" absolute top-[57%] z-[2] right-[-45px] text-two">
              {fullTime}
            </span>
          </>
        )}
...
const MusicPlayerTwo = ({ urls }: { urls: string }) => {
  return (
    <>
      <WaveSurferPlayer
        height={100}
        waveColor="#a46352"
        progressColor="#b53e01"
